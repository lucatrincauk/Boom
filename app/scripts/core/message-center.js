...
directive('mcMessages', ['$rootScope', 'messageCenterService', function($rootScope, messageCenterService) {
  ...
  var templateString = '\
    ...
    <div class="card alert alert-{{ message.type }} {{ animation }}" ng-repeat="message in mcMessages">\
  <div class="item item-icon-left item-text-wrap">\
          <a class="close icon ion-close-circled " ng-click="message.close();" data-dismiss="alert" aria-hidden="true"></a>\
